...
class Paquete(db.Model):
    ...
    dir_destinatario = db.Column(db.String(120),nullable=False)
    ...
    Sucursal_id= db.Column(db.Integer,db.ForeignKey('sucursal.id'))#Se crea una clave foranea con el id de la sucursal con la que se relacionan  los 1..N paquetes
    Transporte_id=db.Column(db.Integer,db.ForeignKey('transporte.id'))#duda Se crea una clave foranea con el id del transporte con el que se relaciona los 1..Npaquetes
...
class Transporte(db.Model):
    ...
    sucursal_id = db.Column(db.Integer, db.ForeignKey('sucursal.id')) #Se crea la clave foranea con el id de la sucursal con la que se relaciona los 1...Ntransportes 
